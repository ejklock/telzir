...
build-front-nocache: ## Build the docker image of Telzir-Backend
	docker-compose  -f telzir-frontend/docker-compose.yml build --no-cache

start-front: ## Build and Start the docker container of Telzir-Backend
	docker-compose  -f telzir-frontend/docker-compose.yml up -d

stop-front: ## Stop the docker container of Telzir-Backend
	docker-compose  -f telzir-frontend/docker-compose.yml stop
